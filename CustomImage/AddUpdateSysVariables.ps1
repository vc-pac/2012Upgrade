...
[Environment]::SetEnvironmentVariable("PATH", "C:\Program Files\Terraforms;C:\Program Files\NodeJS;C:\Program Files\Git", [System.EnvironmentVariableTarget]::Machine)
...
try {
    $job = Start-Job -ScriptBlock $command -Credential $credential
